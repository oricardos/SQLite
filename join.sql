...
INSERT INTO
  "users" ("name", "password", "email", "created")
VALUES
  (
    'Carlos Silva',
    '123456',
...
VALUES
  (
    ...
    'HTML para Iniciantes',
    'Aprenda a linguagem de marcação que é a base da web, começando do zero até páginas completas.',
    40,
    10,
    '2048-02-10 09:00:00'
  ),
  (
    'css-animacoes',
    'CSS - Animações',
    'Domine transições, transforms e keyframes para criar efeitos de movimento modernos em sites.',
    35,
    8,
    '2048-06-22 14:30:00'
  ),
  (
    'javascript-completo',
    'JavaScript Completo',
    'Do básico ao avançado: sintaxe, DOM, ES modules, APIs Web e programação assíncrona.',
    120,
    25,
    '2049-01-18 11:15:00'
  ),
  (
    'sqlite-fundamentos',
    'SQLite - Fundamentos',
    'Entenda a instalação, comandos essenciais, consultas e boas práticas com o banco de dados embarcado.',
    50,
    12,
    '2049-05-05 16:45:00'
  );
...
VALUES
  (
    ...
    300,
    'html01.mp4',
    'Visão geral do HTML e configuração do ambiente.',
    1,
    1,
    '2048-02-15 09:00:00'
  ),
  (
    ...
    420,
    'html02.mp4',
    'Uso das principais tags de estrutura.',
    2,
    0,
    '2048-02-17 09:00:00'
  ),
  (
    1,
    'atributos-e-semantica',
    'Atributos e Semântica',
    'Fundamentos',
    'fundamentos',
    360,
    'html03.mp4',
    'Atributos globais e boas práticas semânticas.',
    3,
    0,
    '2048-02-19 09:00:00'
  ),
  (
    ...
    480,
    'html04.mp4',
    'Inserindo imagens responsivas e links internos/externos.',
    4,
    0,
    '2048-02-21 09:00:00'
  ),
  (
    ...
    540,
    'html05.mp4',
    'Criando tabelas acessíveis e formulários semânticos.',
    5,
    0,
    '2048-02-23 09:00:00'
  ),
  (
    ...
    360,
    'css01.mp4',
    'Introdução às propriedades de transição.',
    1,
    1,
    '2048-06-25 14:30:00'
  ),
  (
    ...
    420,
    'css02.mp4',
    'Aplicando transformações de escala, rotação e translação.',
    2,
    0,
    '2048-06-27 14:30:00'
  ),
  (
    2,
    'keyframes-na-pratica',
    '@keyframes na prática',
    'Animações',
    'animacoes',
    480,
    'css03.mp4',
    'Criando animações complexas com keyframes.',
    3,
    0,
    '2048-06-29 14:30:00'
  ),
  (
    ...
    450,
    'css04.mp4',
    'Controlando timing, delay e iteration count.',
    4,
    0,
    '2048-07-01 14:30:00'
  ),
  (
    ...
    540,
    'css05.mp4',
    'Disparando animações via Intersection Observer.',
    5,
    0,
    '2048-07-03 14:30:00'
  ),
  (
    ...
    300,
    'js01.mp4',
    'História, versões ES e configuração do ambiente.',
    1,
    1,
    '2049-01-20 11:15:00'
  ),
  (
    ...
    420,
    'js02.mp4',
    'let, const, tipos primitivos e conversões.',
    2,
    0,
    '2049-01-22 11:15:00'
  ),
  (
    ...
    480,
    'js03.mp4',
    'Declaração, arrow functions e closures.',
    3,
    0,
    '2049-01-24 11:15:00'
  ),
  (
    ...
    540,
    'js04.mp4',
    'Selecionando e alterando elementos HTML.',
    4,
    0,
    '2049-01-26 11:15:00'
  ),
  ...
  (
    4,
    'introducao-ao-sqlite',
    'Introdução ao SQLite',
    'Fundamentos',
    'fundamentos',
    300,
    'sqlite01.mp4',
    'O que é SQLite e onde usar.',
    1,
    1,
    '2049-05-08 16:45:00'
  ),
  (
    ...
    420,
    'sqlite02.mp4',
    'Sintaxe CREATE TABLE e tipos de dados.',
    2,
    0,
    '2049-05-10 16:45:00'
  ),
  ...
  (
    ...
    600,
    'sqlite05.mp4',
    'Criação de índices e análise de desempenho.',
    5,
    0,
    '2049-05-16 16:45:00'
  );
...
INSERT INTO
  "lessons_completed" ("user_id", "course_id", "lesson_id", "completed")
VALUES
...
INSERT INTO
  "certificates" ("id", "user_id", "course_id", "completed")
VALUES
...
SELECT
  c.id,
  c.title,
  SUM(l.seconds) AS total_segundos
FROM
  courses AS c
  JOIN lessons AS l ON l.course_id = c.id
  AND c.id = 2;
